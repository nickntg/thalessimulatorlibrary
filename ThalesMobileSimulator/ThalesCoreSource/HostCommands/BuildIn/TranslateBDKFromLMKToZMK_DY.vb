...
Namespace HostCommands.BuildIn
    ...
    ''' </remarks>
    <ThalesCommandCode("DY", "DZ", "", "Translates a BDK from LMK to ZMK encryption")> _
    Public Class TranslateBDKFromLMKToZMK_DY
        ...
        Public Overrides Function ConstructResponse() As Message.MessageResponse
            ...
            Dim BDKUnderZMK As String = Utility.EncryptUnderZMK(clearZMK.ToString, Utility.RemoveKeyType(clearBDK.ToString), ZMKks)
            ...
            Log.Logger.MinorInfo("BDK Under ZMK: " + BDKUnderZMK)
            Log.Logger.MinorInfo("Check Value: " + checkValue)

            mr.AddElement(ErrorCodes.ER_00_NO_ERROR)
            mr.AddElement(BDKUnderZMK)
