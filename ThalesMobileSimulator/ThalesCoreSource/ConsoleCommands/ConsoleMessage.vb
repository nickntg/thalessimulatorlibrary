...
Namespace ConsoleCommands
    ...
    Public Class ConsoleMessage
        ...
        Public Property IsNumberOfComponents() As Boolean
            Get
                Return m_isNumberOfComponents
            End Get
            Set(ByVal value As Boolean)
                m_isNumberOfComponents = value
            End Set
        End Property
        ...
        Public Property ConsoleMessageValidator() As IConsoleDataValidator
            Get
                Return m_messageValidator
            End Get
            Set(ByVal value As IConsoleDataValidator)
                m_messageValidator = value
            End Set
        End Property
