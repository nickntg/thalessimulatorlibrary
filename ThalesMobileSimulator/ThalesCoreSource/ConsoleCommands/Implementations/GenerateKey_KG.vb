...
Namespace ConsoleCommands
    ...
    Public Class GenerateKey_KG
        ...
        Public Overrides Sub InitializeStack()
            m_stack.PushToStack(New ConsoleMessage("Enter ZMK check value [ENTER TO SKIP CV TEST]: ", "", New Validators.CheckValueValidator(True)))
            m_stack.PushToStack(New ConsoleMessage("Enter encrypted ZMK [ENTER FOR NONE]: ", "", New Validators.FlexibleHexKeyValidator(True)))
            m_stack.PushToStack(New ConsoleMessage("Key Scheme (ZMK) [ENTER FOR NONE]: ", "", New Validators.KeySchemeValidator(True)))
            m_stack.PushToStack(New ConsoleMessage("Key Scheme (LMK): ", "", New Validators.KeySchemeValidator))
            m_stack.PushToStack(New ConsoleMessage("Key Type: ", "", New Validators.KeyTypeValidator))
            m_stack.PushToStack(New ConsoleMessage("Key length [1,2,3]: ", "", New ExtendedValidator(New Validators.AuthorizedStateValidator) _
        ...
        Public Overrides Function ProcessMessage() As String
            ...
            Dim ZMKCV As String = m_inStack.PopFromStack.ConsoleMessage
            Dim cryptZMK As String = m_inStack.PopFromStack.ConsoleMessage
            Dim keySchemeZMK As String = m_inStack.PopFromStack.ConsoleMessage
            Dim keySchemeLMK As String = m_inStack.PopFromStack.ConsoleMessage
            Dim keyType As String = m_inStack.PopFromStack.ConsoleMessage
            Dim keyLen As String = m_inStack.PopFromStack.ConsoleMessage
