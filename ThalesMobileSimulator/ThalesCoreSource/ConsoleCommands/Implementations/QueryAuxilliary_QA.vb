...
Namespace ConsoleCommands
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <ThalesConsoleCommandCode("QA", "Displays information about the aux port configuration.")> _
    Public Class QueryAuxilliary_QA
        ...
        Public Overrides Function ProcessMessage() As String
            Return "Auxilliary port not configured"
        End Function
