...
Namespace Message.XML
    ...
    Public Class MessageFields
        ...
        Private Shared Function RecursiveReadXMLFields(ByVal xmlFile As String) As MessageFields
            ...
            Using ds As System.Data.DataSet = New System.Data.DataSet
                'Read a dataset from the XML file.
                ds.ReadXml(xmlFile)

                'Process all fields.
                For Each dr As System.Data.DataRow In ds.Tables("Field").Rows
                    ...
                    If ContainsNonNullColumn(dr, "field_id") Then
                        ...
                        If ds.Tables("OptionValue") IsNot Nothing Then
                            For Each drOption As System.Data.DataRow In ds.Tables("OptionValue").Select("field_id=" + id.ToString)
                                Try
                        ...
                        If ds.Tables("ValidValue") IsNot Nothing Then
                            For Each drValid As System.Data.DataRow In ds.Tables("ValidValue").Select("field_id=" + id.ToString)
                                Try
                    ...
                    Else
                        ...
                        'Get field type.
                        fld.MessageFieldType = CType([Enum].Parse(GetType(MessageFieldTypes), Convert.ToString(dr.Item("Type")), True), MessageFieldTypes)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Shared Function ContainsNonNullColumn(ByVal dr As System.Data.DataRow, ByVal columnName As String) As Boolean
            Try
