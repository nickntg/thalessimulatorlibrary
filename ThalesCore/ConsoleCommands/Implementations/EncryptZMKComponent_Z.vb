...
Namespace ConsoleCommands
    ...
    Public Class EncryptZMKComponent_Z
        ...
        Public Overrides Sub InitializeStack()
            _stack.PushToStack(New ConsoleMessage("Enter ZMK Component: ", "", New ExtendedValidator(New Validators.HexKeyValidator) _
        ...
        Public Overrides Function ProcessMessage() As String
            ...
            Dim key As String = _inStack.PopFromStack.ConsoleMessage
