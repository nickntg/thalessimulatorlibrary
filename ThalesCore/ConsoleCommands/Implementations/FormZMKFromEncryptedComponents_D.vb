...
Namespace ConsoleCommands
    ...
    Public Class FormZMKFromEncryptedComponents_D
        ...
        Public Overrides Sub InitializeStack()
            _stack.PushToStack(New ConsoleMessage("Enter encrypted", "", False, True, New Validators.HexKeyValidator))
            _stack.PushToStack(New ConsoleMessage("Enter number of components (2-9): ", "", True, New ExtendedValidator(New Validators.NumberOfComponentsValidator) _
