...
Namespace ConsoleCommands
    ...
    Public Class TripleLengthDESCalculator_T
        ...
        Public Overrides Sub InitializeStack()
            _stack.PushToStack(New ConsoleMessage("Enter data: ", "", New Validators.HexKeyValidator))
            _stack.PushToStack(New ConsoleMessage("Single, Double or Triple length data (S,D,T): ", "", New Validators.DataLengthValidator))
            _stack.PushToStack(New ConsoleMessage("Enter key: ", "", New Validators.HexKeyValidator))
        End Sub
        ...
        Public Overrides Function ProcessMessage() As String
            ...
            Dim data As String = _inStack.PopFromStack.ConsoleMessage
            Dim length As String = _inStack.PopFromStack.ConsoleMessage
            Dim desKey As String = _inStack.PopFromStack.ConsoleMessage
