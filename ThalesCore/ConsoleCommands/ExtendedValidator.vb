...
Namespace ConsoleCommands
    ...
    Public Class ExtendedValidator
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Protected _nextVal As ExtendedValidator = Nothing

        ''' <summary>
        ''' Current validator to be used.
        ''' </summary>
        ''' <remarks></remarks>
        Protected _currentVal As IConsoleDataValidator
        ...
        Public Function Add(ByVal nextValidator As IConsoleDataValidator) As ExtendedValidator
            _nextVal = New ExtendedValidator(nextValidator)
            Return _nextVal
        End Function
        ...
        Public Sub ValidateConsoleMessage(ByVal consoleMsg As String) Implements IConsoleDataValidator.ValidateConsoleMessage
            _currentVal.ValidateConsoleMessage(consoleMsg)
            If _nextVal IsNot Nothing Then
                _nextVal.ValidateConsoleMessage(consoleMsg)
            End If
        End Sub
    End Class
