...
Namespace HostCommands.BuildIn
    ...
    ''' </remarks>
    <ThalesCommandCode("JE", "JF", "", "Translates a PIN from ZPK to LMK encryption")> _
    Public Class TranslatePINFromZPKToLMK_JE
        ...
        Public Overrides Function ConstructResponse() As Message.MessageResponse
            ...
            Dim clearZPK As String = Utility.DecryptUnderLMK(_sourceKey, SOURCE_ZPK, MFPC.GetMessageFieldByName(SOURCE_ZPK).DeterminerName, LMKPairs.LMKPair.Pair06_07, "0")
            ...
            Dim clearPB As String = TripleDES.TripleDESDecrypt(New HexKey(clearZPK), _pb)
            ...
            Dim cryptPIN As String = Me.EncryptPINForHostStorage(clearPIN)
