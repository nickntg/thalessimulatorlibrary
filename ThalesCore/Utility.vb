...
Public Class Utility
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function TryParseInt(ByVal str As String) As Boolean
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetExecutingDirectory() As String
        Dim exePathh As String = Reflection.Assembly.GetExecutingAssembly.ManifestModule.FullyQualifiedName
        If exePathh.IndexOf("\"c) > -1 Then
