...
<TestClass()> Public Class HostCommandTests
    ...
    Public Sub TestGenerateVISAPVV()
        ...
        Assert.AreEqual("000481", TestTran("U183DF6EA5EDFF7D5C91C8F2BA6451884012345500000253211", New GenerateVISAPVV_DG))
    End Sub
    ...
    Public Sub TestVerifyTerminalPINUsingVISAAlgorithm()
        ...
        Assert.AreEqual("01", TestTran("0406FBB23A5214DF367930344805B1FAD6146EF4ED7502B3AE7A708F877571A90155000002532114401", New VerifyTerminalPINWithVISAAlgorithm_DC))
        Assert.AreEqual("00", TestTran("U8463435FC4B4DAA0C49025272C29B12CX367930344805B1FAD6146EF4ED7502B3028DCC093FB0471F0355000002532114402", New VerifyTerminalPINWithVISAAlgorithm_DC))
    ...
    Public Sub TestVerifyInterchangePINUsingVISAAlgorithm()
        ...
        Assert.AreEqual("00", TestTran("U1EF828AA8F6B80EB83E19FBC373F3A85X367930344805B1FAD6146EF4ED7502B391DDDA0A7C12CFAA0155000002532114402", New VerifyInterchangePINWithVISAAlgorithm_EC))
    ...
    Public Sub TestVerifyAndGeneratePVV()
        ...
        Assert.AreEqual("009614", TestTran("002U8463435FC4B4DAA0C49025272C29B12CX367930344805B1FAD6146EF4ED7502B3028DCC093FB0471F0355000002532114402DC90438F79A7A075", New VerifyAndGenerateVISAPVV_CU))
        'Fail both above tests (wrong PVV).
        Assert.AreEqual("01", TestTran("001U1EF828AA8F6B80EB83E19FBC373F3A85X367930344805B1FAD6146EF4ED7502B391DDDA0A7C12CFAA0155000002532114401262D1CC277EF0BB4", New VerifyAndGenerateVISAPVV_CU))
    ...
    Public Sub GenerateMAC()
        Assert.AreEqual("0000085F1448EE", TestTran("01032003U19D25F349FD03CC3556BB05F65283CA1004072C29C2371CC9BDB65B779B8E8D37B29ECC154AA56A8799FAE2F498F76ED92F2", New GenerateMAC_M6))
    ...
    Public Sub VerifyMAC()
        Assert.AreEqual("00", TestTran("01032003U19D25F349FD03CC3556BB05F65283CA1004072C29C2371CC9BDB65B779B8E8D37B29ECC154AA56A8799FAE2F498F76ED92F25F1448EE", New VerifyMAC_M8))
